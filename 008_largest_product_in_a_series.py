...
digits = [7, 3, 1, 6, 7, 1, 7, 6, 5, 3, 1, 3, 3, 0, 6, 2, 4, 9, 1, 9, 2, 2, 5, 1, 1, 9, 6, 7, 4, 4, 2, 6, 5, 7, 4, 7, 4,
...
if digits[:5].count(0) == 0:
    index = 0
else:
    index = digits[:5].index(0)+1

while index < len(digits)-1-5:
    if digits[index+5] == 0:
        index += 5
        continue
